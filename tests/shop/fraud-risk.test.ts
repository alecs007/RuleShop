...
import type { EngineRule, RuleSetSnapshot } from "@/lib/engine";
...
/** Acelasi coș, dar cu adresa de facturare in alta tara. */
...
/** Sesiune cu multe comenzi in ultima ora (semnal de viteza). */
...
describe("assessFraud", () => {
  ...
  it("o regula poate FIXA decizia, peste praguri", () => {
    ...
    // scorul rămâne mare, dar lista alba decide
