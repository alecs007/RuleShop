...
export default async function AccountPage({
  ...
  // Tier and benefits come from the LOYALTY decision over the account's facts
  // with no cart: the customer sees their current status, not a stored one.
  ...
  return (
    <div className="appear-content mx-auto max-w-2xl py-8">
      ...
      <div className="mt-6 rounded-xl border border-line bg-surface-raised p-6">
        ...
        {/* The benefits the rules grant this account */}
